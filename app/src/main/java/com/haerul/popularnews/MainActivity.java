...
public class MainActivity extends AppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static final String API_KEY = "3ebf73a752c54274bb44a2bf00451bde";
    ...
    private String userName, userImage, userID, userIDToken, userEmailID;
        ...
        if (this.getIntent() != null){
           Intent intent = this.getIntent();
            ...
            if (intent.getStringExtra("user_email") != null){
                userEmailID = intent.getStringExtra("user_email");
                Log.d(TAG, "userEmail: "+userEmailID);
            }
            if (intent.getStringExtra("user_id") != null){
                userID = intent.getStringExtra("user_id");
                Log.d(TAG, "userID: "+userID);
            }
            if (intent.getStringExtra("user_id_token") != null){
                userIDToken = intent.getStringExtra("user_id_token");
